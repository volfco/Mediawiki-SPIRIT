    ...
    public function execute() {
            ...
            <div class="navbar navbar-default navbar-fixed-top <?php echo $wgNavBarClasses; ?>" role="navigation">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo $this->data['nav_urls']['mainpage']['href'] ?>" title="<?php echo $wgSitename ?>"><?php echo isset( $wgLogo ) && $wgLogo ? "<img style='height: 50px'  src='{$wgLogo}' alt='Logo'/> " : ''; ?></a>
                    </div>

                    <div class="collapse navbar-collapse top-navbar-collapse">
                        <ul class="nav navbar-nav">
                            <?php echo $this->nav( $this->get_page_links( 'SPIRIT:TitleBar' ) ); ?>
                            <li class="dropdown">
                        ...
                        if ( $wgUser->isLoggedIn() ) {
                            if ( count( $this->data['personal_urls'] ) > 0 ) {
                                ...
                                $user_nav = $this->get_array_links( $this->data['personal_urls'], $name, 'user' );
                                ?>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <!-- If we are not logged in, do not show the subnav bar, and move the search box here -->
                                <li id="function-bar-search">
            ...
            <div class="subnav subnav-fixed" >
                <div class="container">
                    <div class="navbar-header">
                        <ul class="nav navbar-nav">
                            <li>
                                <!-- TODO Fix this, so we are using the bootstrap implementation. I do not know why this is not wokring. -->
                                <button type="button" class="btn btn-navbar navbar-toggle collapsed" data-toggle="collapse" data-target=".subnav-collapse" style="font-size: 22px;">
                                    &#9776;
                                </button>
                            </li>
                            <li id="function-bar-search">
                    ...
                    <div class="navbar-collapse collapse subnav-collapse">
                        <?php if ( $wgUser->isLoggedIn() && count( $this->data['content_actions']) > 0) {
                            $content_nav = $this->get_array_links( $this->data['content_actions'], 'Tools', 'page' ); ?>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?php echo $this->data['content_actions']['talk']['href'] ?>" class="new discussion"><i class="fa fa-comment"></i> Discussion</a></li>
                                <li><a href="<?php echo $this->data['content_actions']['edit']['href']; ?>" class=" edit"><i class="fa fa-pencil"></i> Edit</a></li>
        ...
        <?php } ?>
            ...
            <div class="bottom">
                <div class="container">
                    <footer class="footer">
                        <div class="footer-left col-lg-6 col-md-6 col-sm-6">
                            <div class="col-sm-12 col-md-12">
                                <p class="footer-subtitle">
                                    About
                                </p>
                                <?php $this->includePage('SPIRIT_DATA:Footer_A1'); ?>
                                <?php $this->includePage('SPIRIT_DATA:Footer_A2'); ?>
                                <p style="font-size: 12px;">
                                    <a href="https://sg.rit.edu/">
                                        &copy;&nbsp;&nbsp; Student Government <?php echo date('Y'); ?>.
                                    </a>
                                    <br>
                                    <a href="https://github.com/volfco/MediaWiki-SPIRIT">
                        ...
                        <div class="footer-right col-lg-6 col-md-6 col-sm-6">
                            <div class="col-sm-6 col-sm-offset-1 col-md-4 col-md-offset-1">
                                <p class="footer-subtitle">
                                    Information
                                </p>
                                <p>
                                    <?php $this->includePage('SPIRIT_DATA:Footer_B1'); ?>
                                </p>
                            </div>
                            <div class="col-sm-3 footer-count">
                                <p class="footer-subtitle">
                                    Other Services
                                </p>
                                <p>
                                    <?php $this->includePage('SPIRIT_DATA:Footer_C1'); ?>
                                </p>
                            </div>
                        </div>
                    </footer>
            ...
            if ( array_key_exists( 'sublinks', $topItem ) ) {
                ...
                foreach ( $topItem['sublinks'] as $subLink ) {
                    if ( 'divider' == $subLink ) {
                        ...
                        $output .= "<li {$subLink['attributes']}><a href='{$href}' class='{$subLink['class']} {$slug}'>{$subLink['title']}</a></li>\n";
                    }//end else
                }
                $output .= '</ul>';
                $output .= '</li>';
